...
for imID in df_triplets_train[0]:
    train_0.append(np.load(aim_folder_path+str(imID).split('.')[0]+'.npy'))
for imID in df_triplets_train[1]:
    train_1.append(np.load(aim_folder_path+str(imID).split('.')[0]+'.npy'))
for imID in df_triplets_train[2]:
    train_2.append(np.load(aim_folder_path+str(imID).split('.')[0]+'.npy'))

for imID in df_triplets_test[0]:
    test_0.append(np.load(aim_folder_path+str(imID).split('.')[0]+'.npy'))
for imID in df_triplets_test[1]:
    test_1.append(np.load(aim_folder_path+str(imID).split('.')[0]+'.npy'))
for imID in df_triplets_test[2]:
    test_2.append(np.load(aim_folder_path+str(imID).split('.')[0]+'.npy'))
